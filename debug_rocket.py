...
sol_rocket = solver_rocket.solve(t_span, pos0, v0, pitch, 0.0, 100.0*2*np.pi, max_step=0.1)

print(f"Time: {sol_rocket.t[-1]}")
print(f"Range: {sol_rocket.y[0, -1]}")
print(f"Altitudes: {sol_rocket.y[2, :]}")
